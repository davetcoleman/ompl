    ...
    namespace python
    {
        namespace objects
        {
            ...
            struct dynamic_id_generator
                : mpl::if_<boost::is_polymorphic<T>, boost::python::objects::polymorphic_id_generator<T>,
            ...
            struct dynamic_cast_generator
            {
                ...
                {
                    return dynamic_cast<Target *>(static_cast<Source *>(source));
                }
            };
            ...
            struct cast_generator
                : mpl::if_<is_base_and_derived<Target, Source>, implicit_cast_generator<Source, Target>,
                           dynamic_cast_generator<Source, Target>>
            {
            };

            template <class Source, class Target>
            inline void register_conversion(bool is_downcast = ::boost::is_base_and_derived<Source, Target>::value
