...
#include <ompl_experience_demos/_graph_detail.h>
#include <ompl_experience_demos/Graph.h>
...
{
    return 1;
    // TODO make the heuristic CORRECT !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!1
...
edgeWeightMap::edgeWeightMap (const Graph &graph, const std::vector<Edge> &avoidThese)
